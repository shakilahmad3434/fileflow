...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-yellow-100 flex items-center justify-center px-12 py-20">
      <div className="w-full max-w-6xl flex flex-col lg:flex-row shadow-2xl rounded-3xl overflow-hidden bg-white">
        ...
        <div className="lg:w-1/2 bg-gradient-to-br from-violet-600 to-indigo-800 p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">Manage your files with ease</h1>
            <p className="text-lg text-indigo-100 mb-8 max-w-md">Access, share, and collaborate on your documents from anywhere in the world.</p>
          </div>
          ...
          <div className="relative z-10 space-y-6 mt-auto">
            <div className="flex items-center bg-white bg-opacity-10 p-4 rounded-xl backdrop-blur-sm">
              ...
              <div className="ml-4">
                <h3 className="text-gray-700 font-medium">Bank-level security</h3>
                <p className="text-gray-500 text-sm">Your files are encrypted and protected</p>
              </div>
            </div>
            ...
            <div className="flex items-center bg-white bg-opacity-10 p-4 rounded-xl backdrop-blur-sm">
              ...
              <div className="ml-4">
                <h3 className="text-gray-700 font-medium">Cloud synchronization</h3>
                <p className="text-gray-500 text-sm">Access your files from any device</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 p-8 lg:p-12">
          <div className="max-w-md mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500">Sign in to continue to FileFlow</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <a href="/forgot-password" className="text-xs text-indigo-600 hover:text-indigo-500 font-medium">Forgot password?</a>
                </div>
                <div className="relative rounded-lg shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="rememberMe" className="ml-2 block text-sm text-gray-600">Remember me for 30 days</label>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600">
                Don't have an account? <a href="/signup" className="text-indigo-600 font-medium hover:text-indigo-500">Create an account</a>
              </p>
            </div>
          </div>
        </div>
