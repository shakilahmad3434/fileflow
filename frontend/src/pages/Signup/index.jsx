        ...
        <div className="lg:w-1/2 bg-gradient-to-br from-violet-600 to-indigo-800 p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center mb-12">
              <div className="bg-white text-indigo-600 font-bold p-2 rounded-md shadow-lg mr-2">F</div>
              <span className="text-xl font-bold text-white">FileFlow</span>
            </div>
            
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">Start your journey today</h1>
            <p className="text-lg text-indigo-100 mb-8 max-w-md">Join thousands of professionals managing and collaborating on files with our powerful platform.</p>
          </div>
          ...
          <div className="relative z-10 space-y-5 mt-auto">
            <div className="flex items-center bg-white bg-opacity-10 p-4 rounded-xl backdrop-blur-sm">
              ...
              <div className="ml-4">
                <h3 className="text-gray-700 font-medium">Enterprise-level security</h3>
                <p className="text-gray-500 text-sm">Military-grade encryption for all your files</p>
              </div>
            </div>
            ...
            <div className="flex items-center bg-white bg-opacity-10 p-4 rounded-xl backdrop-blur-sm">
              ...
              <div className="ml-4">
                <h3 className="text-gray-700 font-medium">Advanced collaboration</h3>
                <p className="text-gray-500 text-sm">Work with your team in real-time</p>
              </div>
            </div>
            ...
            <div className="flex items-center bg-white bg-opacity-10 p-4 rounded-xl backdrop-blur-sm">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-500 text-sm">Never lose important work again</p>
              </div>
            </div>
            ...
            <div className="mt-8 bg-white bg-opacity-10 p-5 rounded-xl backdrop-blur-sm">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="text-gray-700 italic text-sm">"FileFlow has completely transformed how our team manages documents. The automated workflows have saved us countless hours every week."</p>
                  <p className="text-xs text-gray-500 mt-2 font-medium">— Sarah Johnson, Marketing Director</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:w-1/2 p-8 lg:p-12">
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500">Join FileFlow in just a few simple steps</p>
            </div>
              ...
              <div className="flex items-start mt-6">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="agreeTerms" className="text-gray-600">
                    I agree to the <a href="/terms" className="text-indigo-600 hover:text-indigo-500 font-medium">Terms of Service</a> and <a href="/privacy" className="text-indigo-600 hover:text-indigo-500 font-medium">Privacy Policy</a>
                  </label>
                </div>
              </div>
